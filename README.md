...
2. YAML - From the final Project 31 model I have implemented a YAML pipeline to test the model GitHub Actions directly and it ran successfully; Different from our Team Implementation which runs on Colab.
3. Fully defined environments as included in the requirements.txt
4. Different file structure and tests flow; all encompasing.
## Project Overview
...
The oracle simulates access decisions (GRANT/DENY), and a comprehensive test suite validates the implementation.
### Project Structure
amueke/amueke
├── README.md
├── model.py
...
**
VIDEO RECORDING LINK - https://1drv.ms/v/c/1dd137b4fc5b4b79/IQC6PpzpUgTAQ7497fXdMuNlAeRrmNf1kkNKEB5vyIRiR_Q?e=OTo7t7
